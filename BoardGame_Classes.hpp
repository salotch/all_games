...
using namespace std;
string playerx_n;//player x name needed in 5*5 game
class Board {
protected:
   int n_rows, n_cols;
   char** board;
...
//////////////////////////
// This class represents a player in 5x5 game who has
// a name and a symbol to put on board
class player_5x5:public Player{
...
//    // Optionally, you can give him ID or order
//    // Like Player 1 and Player 2
    player_5x5 (int order, char symbol);
...
////////////////////////////////////////////////////////////
class pyramid_RandomPlayer: public Player {
protected:
    int dimension, dimension1;
public:
    // Take a symbol and pass it to parent
    pyramid_RandomPlayer (char symbol, int dimension,int dimension1);
